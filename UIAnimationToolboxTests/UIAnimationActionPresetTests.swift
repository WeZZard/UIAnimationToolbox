...
class UIAnimationActionPresetTests: XCTestCase {
    ...
    // MARK: - Terminates Action Searching
    func testTerminatesActionSearching_returnsTrue_when_presentAction_isOfTypeNSNull() {
        let action = UIAnimationActionPreset(presetAction: NSNull())
        XCTAssertTrue(action.terminatesActionSearching)
    }
    
    func testTerminatesActionSearching_returnsFalse_when_presentAction_isNotOfTypeNSNull() {
        let action = UIAnimationActionPreset(presetAction: UIAnimationActionPreset(presetAction: NSNull()))
        XCTAssertFalse(action.terminatesActionSearching)
    }
}
